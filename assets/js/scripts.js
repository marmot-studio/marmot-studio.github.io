document.addEventListener("DOMContentLoaded", function() {
  ...
  var TiltObj = function(el, options) {
    this.el = el;
    this.options = extend({}, this.options);
    extend(this.options, options);
    this.DOM = {
      img: this.el.querySelector(".image"),
  ...
  TiltObj.prototype._layout = function(e) {
  ...
  var DOM = {};
	...
	DOM.contentElems = Array.prototype.slice.call(document.querySelectorAll(".section"));
  DOM.contentLinks = Array.prototype.slice.call(document.querySelectorAll(".link"));
  ...
  var createScrollWatchers = function() {
    DOM.contentElems.forEach(function(el, pos) {
      var scrollElemToWatch = DOM.contentElems[pos];
  ...
  var init = function() {
    imagesLoaded(document.body, function() {
      ...
      Array.prototype.slice.call(document.querySelectorAll(".card")).forEach(function(el) {
